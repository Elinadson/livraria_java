	...
	<div id="carouselSite" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item">
				<img scr="imagens/livraria.jpg" class="img-fluid" d-block>
			</div>
			<div class="carousel-item">
				<img scr="imagens/livraria2.jpg" class="img-fluid" d-block>
			</div>
			<div class="carousel-item">
				<img scr="imagens/livraria3.jpg" class="img-fluid" d-block>
			</div>
		</div>
	</div>
